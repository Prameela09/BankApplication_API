        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WithdrawLimit = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    MinimumBalance = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    OverDraft = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentInterestRate = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    CurrentMonthlyFee = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Accounts_StatusTypes_StatusTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_StatusTypes_StatusId",
                        column: x => x.StatusId,
                        principalTable: "StatusTypes",
                        principalColumn: "StatusTypeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_SourceTypes_SourceTypeId",
                        column: x => x.SourceTypeId,
                        principalTable: "SourceTypes",
                        principalColumn: "SourceTypeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_StatusTypes_StatusTypeId",
                        column: x => x.StatusTypeId,
                        principalTable: "StatusTypes",
                        principalColumn: "StatusTypeId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_SourceTypeId",
                table: "Transactions",
                column: "SourceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_StatusTypeId",
                table: "Transactions",
                column: "StatusTypeId");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "AadharNumber",
                unique: true,
                filter: "[AadharNumber] IS NOT NULL");
